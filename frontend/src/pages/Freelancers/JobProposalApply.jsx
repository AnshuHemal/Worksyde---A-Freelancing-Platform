...
const JobProposalApply = () => {
  ...
  // ["", "ws", "proposals", "job", "~6842d69ab5d7d6f3b5cb99e8", "apply"]
          ...
          <div className="row justify-content-center">
            <div className="col-12">
              ...
              >
                ...
                >
                  Showcase your expertise and win this job!
                </p>
              </motion.div>
              ...
              <div className="row justify-content-center">
                ...
                {/* Right column: Job Summary, Client Info, Pro Tips */}
                  ...
                  >
                    <div className="card-body p-4">
                      ...
                      <div className="my-4">
                        ...
                        {/* JobCard skill-tag style injection */}
                        <style>{`
                          .skill-tag {
...
export default JobProposalApply;
