    ...
    <div className="row g-0">
      <div className="col-lg-8 p-4">
        ...
        <div className="d-flex flex-wrap mb-3 mt-3">
          {[1, 2, 3, 4].map((i) => skeletonBox(32, 120, 16))}
        </div>
        {skeletonBox(20, 180)}
        {skeletonBox(80, "100%", 12)}
        <div className="d-flex flex-wrap mb-3 mt-3">
          {[1, 2, 3].map((i) => skeletonBox(28, 80, 12))}
        </div>
      </div>
            ...
            {!jobDetails ? (
              ...
              <div className="row g-0">
                ...
                <div className="col-lg-8" style={{ padding: 30 }}>
                  {/* Header */}
                  <div className="mb-4">
                    <h2 className="fw-semibold mb-3" style={{ color: "#121212", fontSize: "2rem", lineHeight: "1.3", letterSpacing: "0.3px" }}>
                      {jobDetails.title}
                    </h2>
                    ...
                    <div className="col-md-6">
                      <div style={cardSection} className="h-100">
                        <div className="d-flex align-items-center gap-3 mb-3">
                          <div style={{ width: 50, height: 50, borderRadius: "50%", background: "linear-gradient(135deg, #007674 0%, #005a58 100%)", display: "flex", alignItems: "center", justifyContent: "center", color: "white" }}>
                            <BsCurrencyDollar size={24} />
                          </div>
                          <div>
                            <h6 className="fw-semibold mb-1" style={{ color: "#121212" }}>Hourly Rate</h6>
                            <p className="mb-0" style={{ color: "#007674", fontSize: "1.1rem", fontWeight: "600" }}>
                              ₹{jobDetails.hourlyRateFrom} - ₹{jobDetails.hourlyRateTo}
                            </p>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="col-md-6">
                      <div style={cardSection} className="h-100">
                        <div className="d-flex align-items-center gap-3 mb-3">
                          ...
                          <div>
                            <h6 className="fw-semibold mb-1" style={{ color: "#121212" }}>Applicants</h6>
                            <p className="mb-0" style={{ color: "#007674", fontSize: "1.1rem", fontWeight: "600" }}>
                  ...
                  {/* Description */}
                  <div className="mb-4">
                    <h5 className="fw-semibold mb-3" style={{ color: "#121212", fontSize: "1.4rem" }}>Job Description</h5>
                    <div className="p-4 rounded-4" style={{ background: "#f8f9fa", border: "1px solid #e3e3e3", lineHeight: "1.7" }}>
                      <p style={{ color: "#333", fontSize: "1.1rem", whiteSpace: "pre-wrap", margin: 0 }}>{jobDetails.description}</p>
                    </div>
                  </div>
                  {/* Skills & Expertise */}
                  <div className="mb-4">
                    <h5 className="fw-semibold mb-3" style={{ color: "#121212", fontSize: "1.4rem" }}>Skills & Expertise</h5>
                  ...
                  {/* Project Details */}
                  <div className="mb-4">
                    <h5 className="fw-semibold mb-3" style={{ color: "#121212", fontSize: "1.4rem" }}>Project Details</h5>
                    <div className="row g-3">
                      <div className="col-md-6">
                        <div className="p-3 rounded-3" style={{ background: "#f8f9fa", border: "1px solid #e3e3e3" }}>
                          <div className="d-flex align-items-center gap-2 mb-2">
                            <BsBriefcase size={16} style={{ color: "#007674" }} />
                            <span className="fw-semibold" style={{ color: "#121212" }}>Scope</span>
                          </div>
                          <p className="mb-0" style={{ color: "#666", fontSize: "1rem" }}>{jobDetails.scopeOfWork}</p>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="p-3 rounded-3" style={{ background: "#f8f9fa", border: "1px solid #e3e3e3" }}>
                          <div className="d-flex align-items-center gap-2 mb-2">
                            ...
                            <span className="fw-semibold" style={{ color: "#121212" }}>Duration</span>
                          </div>
                          <p className="mb-0" style={{ color: "#666", fontSize: "1rem" }}>{jobDetails.duration}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="col-lg-4" style={rightCard}>
                  ...
                  >
                    ...
                    <div className="p-4 rounded-4" style={{ background: "#fff", border: "1px solid #e3e3e3", boxShadow: "0 2px 8px rgba(0, 0, 0, 0.05)" }}>
                      <div className="d-flex align-items-center gap-2 mb-2">
                        <BsCheckCircle size={20} style={{ color: "#28a745" }} />
                  ...
                  >
                    ...
                    <div className="p-4 rounded-4" style={{ background: "linear-gradient(135deg, rgba(0, 118, 116, 0.05) 0%, rgba(0, 118, 116, 0.02) 100%)", border: "1px solid rgba(0, 118, 116, 0.1)" }}>
                      <ul className="mb-0" style={{ color: "#666", fontSize: "1rem" }}>
                        <li className="mb-2">Double-check your job details for accuracy</li>
                        <li className="mb-2">Well-presented jobs attract better freelancers</li>
                        <li className="mb-2">Be specific about your needs and expectations</li>
                        <li className="mb-0">You can always update your post later</li>
                      </ul>
                    </div>
                  </motion.div>
                </div>
